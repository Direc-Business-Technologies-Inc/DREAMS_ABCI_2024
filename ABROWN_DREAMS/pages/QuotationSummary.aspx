<%@ Page Title="DREAMS | Quotation Summary" Language="C#" MasterPageFile="~/master/Main.Master" AutoEventWireup="true" CodeBehind="QuotationSummary.aspx.cs" Inherits="ABROWN_DREAMS.QuotationSummary" %>
                                            ...
                                            <ContentTemplate>
                                                <table class="table">
                                                    ...
                                                    <tr runat="server" visible="false">
                                                        <th>Adjacent Lot:</th>
                                                        <td>
                                                            <asp:Label runat="server" ID="lblAdjacentLot" /></td>
                                                    </tr>
                                                    <tr>
                                                        <th>House Model:</th>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label runat="server" ID="lblTaxClassification" /></td>
                                                    </tr>
                                                    <tr>
                                                        <th>LOI:</th>
                                                        <td>
                                                    ...
                                                    <%--2023-11-07 : REQUESTED TO BE ADDED BY DHEZA--%>
                                                    <tr>
                                                        <th>Broker Name:</th>
                                                        <td>
                                                            <asp:Label runat="server" ID="lblBrokerName" /></td>
                                                    </tr>

                                                    <%--2023-11-07 : REQUESTED TO BE ADDED BY DHEZA--%>
                                                    <tr>
                                                        <th>Broker Business Name:</th>
                                                        <td>
                                                            <asp:Label runat="server" ID="lblBrokerBusinessName" /></td>
                                                    </tr>
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                            <div class="input-group">
                                                                <input type="text" style="z-index: auto;" class="form-control text-uppercase" runat="server" id="txtCoowner" readonly /><span class="input-group-btn">
                                                                    <button id="btnCoOwner" runat="server" style="width: 50px; z-index: auto;" data-toggle="modal" data-target="#MsgCoOwner" class="btn btn-secondary" type="button"><i class="fa fa-bars"></i></button>
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <asp:CustomValidator
        ...
        <div class="modal-dialog modal-lg" style="width: 80%;">
            <div class="modal-content">
                <div class="modal-header" style="background-color: dodgerblue">
                    ...
                    <h4 class="modal-title" style="color: white;">Quotation List</h4>
                </div>
                        ...
                        <ContentTemplate>
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="col-lg-3">
                                            <asp:CheckBox CssClass="checkbox checkbox-inline" Text="Per Project Code" AutoPostBack="true" runat="server" ID="chkPerProject" OnCheckedChanged="chkPerProject_CheckedChanged" />
                                        </div>
                                        <div class="col-lg-3">
                                            <asp:CheckBox CssClass="checkbox checkbox-inline" Text="Per Project Name" AutoPostBack="true" runat="server" ID="chkPerProjectName" OnCheckedChanged="chkPerProject_CheckedChanged" />
                                        </div>
                                        ...
                                        <ContentTemplate>
                                            <asp:GridView runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Model" HeaderText="House Model" />
                                                    ...
                                                    <asp:BoundField DataField="LOI" HeaderText="LOI" />
                                                    <asp:BoundField DataField="SellingPrice" HeaderText="Selling Price" DataFormatString="{0:N}" />
                                                    ...
                                                    <asp:BoundField DataField="LTSNo" HeaderText="LTS No" DataFormatString="{0:N}" NullDisplayText=" " />
                                        ...
                                        <asp:UpdatePanel runat="server">
                                            <ContentTemplate>
                                                <asp:GridView runat="server" ID="gvCommissionScheme"
                                                    ...
                                                    AllowPaging="true"
                                                    PageSize="12"
                                                    OnPageIndexChanging="gvCommissionScheme_PageIndexChanging1"
                                                    GridLines="None"
                                                    ShowHeader="true">
                                                    <HeaderStyle BackColor="#66ccff" />
                                                    <Columns>
