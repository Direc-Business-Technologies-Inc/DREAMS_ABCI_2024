<%@ Page Title="DREAMS | Commission" Language="C#" MasterPageFile="~/master/Main.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="Commission.aspx.cs" Inherits="ABROWN_DREAMS.pages.Commission" %>
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-3 col-xs-6">
                                        <div class="input-group">
                                            <input runat="server" id="txtSearch" placeholder="Search here" class="form-control" type="text" autofocus /><span class="input-group-btn">
                                                <asp:LinkButton runat="server" ID="bSearch" Style="width: 50px;" CssClass="btn btn-default" OnClick="bSearch_Click"><i class="fa fa-search"></i></asp:LinkButton>
                                            </span>
                                        </div>
                                    </div>
                                        ...
                                        <ContentTemplate>
                                            <asp:GridView runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="SharedPerson" HeaderText="Shared Person" ItemStyle-CssClass="" />
                                                    <%--5--%>
                                                    ...
                                                    <asp:BoundField DataField="Id" HeaderText="Project" ItemStyle-CssClass="hide" HeaderStyle-CssClass="hide" />
                                                    <asp:BoundField DataField="SAPCardCode" HeaderText="SAP BP" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="hide" />
                                                    <%--15--%>
                                                    <asp:BoundField DataField="NetTcp" HeaderText="Net Tcp" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="hide" DataFormatString="{0:#,##0.00}" />
                                                    <asp:BoundField DataField="PaidAmnt" HeaderText="PaidAmnt" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="hide" DataFormatString="{0:#,##0.00}" />
                                                    <asp:BoundField DataField="TransType" HeaderText="TransType" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="hide" />
                                                    <%--<asp:BoundField DataField="CommissionRemark" HeaderText="CommissionRemark" ItemStyle-CssClass="" HeaderStyle-CssClass="" />--%>
                                                    <asp:TemplateField HeaderText="Remarks">
                                                        <ItemTemplate>
                                                            <asp:TextBox runat="server" ID="txtCommissionRemarks" CssClass="form-control input-sm" Width="200px" ReadOnly="true"></asp:TextBox>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:BoundField DataField="SONo" HeaderText="SONo" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="hide" />
                                                    <%--20--%>
                                                    <asp:BoundField DataField="FinancingScheme" HeaderText="FinancingScheme" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="hide" />
                                                    <asp:BoundField DataField="TaxClassification" HeaderText="TaxClassification" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="hide" />
                                                    <asp:BoundField DataField="Booked" HeaderText="Booked" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="hide" />
                                                    <asp:BoundField DataField="CollectedTCP" HeaderText="CollectedTCP" ItemStyle-CssClass="Hide" HeaderStyle-CssClass="hide" />

                                                </Columns>
                                                <EmptyDataRowStyle HorizontalAlign="Center" BackColor="#D7DCE5" ForeColor="Black" />
