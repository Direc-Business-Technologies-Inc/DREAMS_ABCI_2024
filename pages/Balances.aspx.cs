...
{
    public partial class Balances : Page
    {
        ...
        protected void bPaymntmeans_ServerClick(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in gvDownpayment.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    //dt.Rows.Add(chkRow.Checked, Terms, DueDate, SystemClass.ToCurrency(MonthlyAmort.ToString()), Principal, Interest, SystemClass.ToCurrency(ActualPay.ToString()), Balance);
