    ...
    public partial class BrokerPage : System.Web.UI.Page
    {
        ...
        protected void btnSubmitID_ServerClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string qry = $@"SELECT * FROM ""OBRK"" WHERE ""BrokerId"" = '{(brokerId).Replace(" ", "")}'";
                ...
                {
                    alertMsg("The Broker is already accepted. Cannot be edited", "warning");
                }
        ...
        void LoadDataheader()
        {
            try
            {
                ...
                if (dtBrokerHeader.Rows.Count != 0)
                {
                    ...
                    txtEmailAddress.Text = DataAccess.GetData(dtBrokerHeader, 0, "EmailAddress", "").ToString();
                    ...
                    txtContactEmail.Text = DataAccess.GetData(dtBrokerHeader, 0, "EmailContact", "").ToString();
                    ...
                    qry = $@"SELECT ""Id"", ""SalesPersonId"", ""PositionSharedDetails"" ""Position"", ""SalesPersonNameSharedDetails"" ""SalesPersonName"", IFNULL(""PercentageSharedDetails"",'7') ""LotOnlyPercentage"", IFNULL(""HouseandLotSharingDetails"",'5') ""HouseandLotPercentage"", ""OslaID"", ""TransID"" FROM ""BRK2"" WHERE ""BrokerId"" = '{txtUniqueIdSet.Text.Trim()}'";
                    ...
                    qry = $@"SELECT 
                            ...
                            TO_CHAR(""CreateDate"", 'MM-DD-YYYY') AS ""CreateDate"",
                            ""Id"",
                            ""Type""
                        FROM ""temp_BRK2""
        ...
        protected void btnYes_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //JOSES
                string emaillAdd = txtEmailAddress.Text;
                ...
                else
                {
                    ...
                    if (ret == "Operation completed successfully.")
                    {
                        ...
                        if (retbool)
                        {
                            ...
                            string emailaddress = rbTypeOfBusiness.SelectedIndex == 0 ? txtEmailAddress.Text : txtContactEmail.Text;
        ...
        protected void bUpdatesalesPersons_Command(object sender, CommandEventArgs e)
        {
            try
            {
                ...
                mtxtEmail.Text = DataAccess.GetData(dtOSLA, 0, "EmailAddress", "").ToString();
